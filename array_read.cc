...
int main () {
	...
	for (int k=0; k<10; k++) array[k]=0;		// Array wird in jeder Stelle auf 0 gesetzt
	...
	cin>>input;												// Eingabe Wert fuer Array
		...
		if (input<-1) {cout<<"Nur positive Zahlen erlaubt\n!"; i=-100;}	// Abfangen negativer Eingaben außer "-1"
		
		else if (input==-1) {cout<<"Programm terminiert!\n"; i=-100;}		// "-1" terminiert
